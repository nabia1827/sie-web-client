...
function ModalNuevaAudiencia(props) {
    const { modalOpen, handleOk, handleCancel } = props;
    ...
    const onFinished = () => {
        ...
        const newEvent = {
            color: typeof audienciaColor === 'object' ? audienciaColor.toHexString() : audienciaColor,
            start: startTime,
            end: endTime,
            usuId:usuId,
            audienciaTipoId: audienciaTipoId,
            link: audienciaLink,
            observaciones: audienciaObservaciones,
            legajoId: legajoId,
        }
        form.resetFields();
        handleOk(newEvent);
