...
import ResultadoCard from "../consultaLegajos/ResultadoCard";
import { ColumnsResultado } from "../../utils/nuevoLegajo/columnsResultadoColapserTable";

function CollapserResultado(props) {
    const { showMdApel, resultados, loading, showMdEditRes, showMdDelRes, typeOfDesign } = props;
