...
function ModalDelImputado(props) {
    ...
    return (
        <>
            ...
            >
                ...
                <Text>¿Estás seguro que deseas eliminar el registro del imputado?</Text >
...
export default ModalDelImputado;