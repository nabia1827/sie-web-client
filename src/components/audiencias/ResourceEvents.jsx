...
import { CellUnit, DATETIME_FORMAT, SummaryPos, DnDTypes } from '../../utils/audiencias/default';
...
class ResourceEvents extends Component {
  ...
  stopDrag = ev => {
    ...
    if (cellUnit !== CellUnit.Hour) {
      endTime = localeDayjs(new Date(resourceEvents.headerItems[rightIndex - 1].start)).hour(23).minute(59).second(59)
