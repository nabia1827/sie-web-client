                ...
                <Row justify={"center"} align={"center"} style={{ width: "100%" }}>
                    <Col xs={24} sm={24} md={24} lg={24} xl={24} style={{ padding: "0.7em" }}>
                        ...
                        <Row gutter={[12, 12]} justify={"center"} align={"top"} style={{ width: "100%" }}>
                            ...
                            <Col xs={24} sm={24} md={12} lg={12} xl={6}>
                                <Form.Item
                                    style={{ width: "100%", marginBottom: "0",whiteSpace: "normal"}}
                                ...
                                >
                                    <Select
                                        style={{ width: "100%", marginBottom: "0",textAlign: "left",whiteSpace: "normal" }}
                            ...
                            {delitos.map(d => (
                                <Col xs={24} sm={24} md={24} lg={24} xl={12}>
                                    <div style={{ textAlign: 'left', display:"flex"}}>
                                        <div style={{ fontSize:"18px",textAlign: 'center', alignContent:"center", marginRight: '4px', color: '#ff4d5e'}}>
                                            *
                                        </div>
                                        
                                        <Text className="sie-info-column-content">
                                            Detalle para {d.delitoNombre}
                                        </Text>
                                    </div>
