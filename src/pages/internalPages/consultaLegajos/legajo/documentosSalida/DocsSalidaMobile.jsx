...
import DocSalidaCard from "../../../../../components/consultaLegajos/DocSalidaCard";

function DocsSalidaMobile(props) {
            ...
            <Spin spinning={loadingDocsSalida} style={{ width: "100%", minHeight: "60vh" }}>
                {legajo ? (
                    <Flex vertical justify="flex-start" align="center" style={{ width: "100%", padding: "1.7em", minHeight: "74vh", backgroundColor: "white", borderRadius: "0.7em" }}>
                        <Flex gap={"small"} vertical justify="flex-start" align="flex-start" style={{ width: "100%" }}>
                        ...
                        <Flex vertical gap={"small"} justify="flex-start" align="center" style={{ width: "100%" }}>
                            {docsSalida?.map((d, index) => (
                                <DocSalidaCard index={index} showMdEditarRecurso={showMdEditarRecurso} doc={d} onClickDownload={onClickDownload}
                                    loadingsPDF={loadingsPDF} ></DocSalidaCard>
                            ))
                            }
...
export default DocsSalidaMobile;