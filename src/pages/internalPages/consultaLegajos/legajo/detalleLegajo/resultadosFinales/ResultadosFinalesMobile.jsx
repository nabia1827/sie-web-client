...
import ResultadoCard from "../../../../../../components/consultaLegajos/ResultadoCard";

function ResultadosFinalesMobile(props) {
                ...
                {resultados.length > 0 ? (
                    <Flex vertical justify="flex-start" align="center" style={{ width: "100%", padding: "1.0em" }}>
                        ...
                        <Flex vertical gap={"small"} justify="flex-start" align="center" style={{ width: "100%" }}>
                            {resultados?.map((r) => (
                                <ResultadoCard resultado={r} showMdApel ={showMdApel}/>
                            ))
